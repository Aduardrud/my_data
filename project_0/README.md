...
*******
- Входные данные программа генерирует сама.

:arrow_up: [К оглавлению](https://github.com/Aduardrud/my_data/blob/main/project_0/README.md#Оглавление)

### Этапы работы над проектом
*******
- Предварительно изучены основы Pithon.
- Изучены основные инструменты для работы       дата-сайентиста

:arrow_up: [К оглавлению](https://github.com/Aduardrud/my_data/blob/main/project_0/README.md#Оглавление)

### Результат
*******
- Написана программа, угадывающая число в среднем за 7 попыток.
...
*******
*******
- В ходе выполнения проекта опытным путём убедились что Pithon достаточно гибкий и многофункциональный язык, позволяющий решать поставленные задачи множеством различных встроенных в него инструментов.
